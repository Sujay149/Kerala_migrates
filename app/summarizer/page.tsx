    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 429) {
          ...
          throw new Error("API access denied. Please check your configuration.");
...
- Ensure you're not behind a restrictive firewall or proxy.
- Try refreshing the page and attempting again.

**Note:** This service requires an active internet connection. For offline medical assistance, consult your local healthcare provider.`;
      }

      return `**ERROR SUMMARY**

- ${error instanceof Error ? error.message : 'Failed to generate summary due to an unknown issue.'}
