...
export default function AppointmentsPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const handleOnline = () => setError(false);
      const handleOffline = () => {
        setError(true);
      ...
      if (!navigator.onLine) {
        ...
        toast.error("Failed to connect to appointment service. Please refresh the page.");
      }
    }
  }, [user]);
  ...
  const getStatus = (apt: Appointment) => {
    ...
    if (aptDate < now) return { label: "Done", color: "bg-green-600" };
    if (aptDate.getTime() - now.getTime() < 24 * 60 * 60 * 1000) return { label: "Soon", color: "bg-yellow-600" };
    return { label: "Scheduled", color: "bg-primary" };
  };
      ...
      <div className="flex min-h-screen bg-white dark:bg-[#0e1a2b] text-black dark:text-white">
        ...
        <div className="flex-1 overflow-y-auto px-4 pt-10 max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1 mb-6">Choose from our comprehensive healthcare network</p>
          </div>
  ...
  <div className="flex flex-col md:flex-row items-center gap-8">
    ...
    <div className="flex-1">
      ...
      />
          ...
          {/* Error Message */}
          {error && (
            <div className="mt-4 bg-card text-destructive px-4 py-3 rounded-xl text-center shadow">
